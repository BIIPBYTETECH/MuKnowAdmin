...
//                                                }
                                            ...
                                            <button type="button" class="article_edit_button btn smile-primary subbtn"><?php echo $lang_submit; ?></button>
                                        ...
                                        <?php if ($mode == 'view'): ?>
                                            ...
                                            <div class="row" style="margin-left: 0px;margin-right: 0px;">
                                                <div class="panel-heading sectionhead" style="background-color: #0aa959 !important;color: #fff;margin:0px 15px 0px 15px;">
                                                    <?php echo $lang_articlesdetails; ?>
                                                        ...
                                                        <div id="tab-content" class="tab-content">
                                                            <?php if (!$this->ion_auth->is_contributor()): ?>
                                                                <div id="tab1" class="tab-pane fade in active">
                                                                    <div class="row" style="margin-left: 0px;margin-right: 0px;">
                                                                        <div class="panel-heading" style="background-color:#0aa959 !important;color:#fff;">
                                                                            <?php echo $lang_articlesdetails; ?>
                                                                        </div>
                                                                        <!-- /.panel-heading -->
                ...
                <!--                                                                                                            <select class="form-control status_check_active" data="<?php echo $row->id; ?>">
                                                            ...
                                                            <div id="tab2" class="tab-pane fade">
                                                                <div class="row" style="margin-left: 0px;margin-right: 0px;overflow-y:scroll;">
                                                                    <div class="panel-heading" style="background-color: #0aa959 !important;color:#fff;margin-right: -100px !important;">
                                                                        <?php echo $lang_articlesdetails; ?>
                                                                    </div>
                                                                    <!-- /.panel-heading -->
                                                                    <div class="panel-body">
                                                                ...
                                                                <div class="row" style="margin-left: 0px;margin-right: 0px;">
                                                                    <div class="col-lg-12">
                                                                        <div class="panel panel-default">
                                                                            <div class="panel-heading">
                                                                                <?php echo $lang_articlesdetails; ?>
                                                                                <a style="margin-top: -6px;float: right;" href="<?php echo site_url() ?>admin/Dashboard_articles/index/<?php echo $this->ion_auth->user()->row()->id; ?>"> <button type="button" class="btn btn-info closebtn"><?php echo $lang_back; ?></button></a>
                                                                            </div>
                                                                            <?php //echo form_open_multipart(site_url() . '/admin/Dashboard_articles/add_edit_article', 'id="cat_form" class=".validate"');           ?>
...
//                                                                                                echo form_dropdown('sp_id', $main_category, @$main_category->id, $options);
                                                                                            ...
                                                                                            <div class="row">
                                                                                            <div class="col-md-6 form-group">
                                                                                                    <label><?php echo 'Select Author'; ?></label>
                                                                                                    <select  name="author" data-placeholder="' . $lang_choosecategory . '..." class="form-control category_id select-full required" tabindex="2"tabindex="2">
                                                                                                        <option value=""><?php echo 'Choose Author'; ?></option>
                                                                                                        <?php
                                                                                                        if (!empty($authors)):
...
<!--                                                                                            <div class="image_rows ">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <a class="btn smile-primary btn" href="javascript;" data-toggle="modal" data-target="#upload-logo-form2"><?php echo $lang_upload; ?></a><span id="img_name2" style="font-weight: bold;margin-left: 5px;"><b><b></span>
                                                                                                              ...
                                                                                                              <div class="form-group">
                                                                                                <label><?php echo 'Video Type'; ?>:</label>

                                                                                                <select style="height:40px !important;" id="video_type" name="video_type" class="form-control  required">
                                                                                                    <option value=""><?php echo 'Choose Video Type'; ?></option>
<!--                                                                                                    <option value="2"><?php echo $lang_image; ?></option>-->
                                                                                                    <option value="1"><?php echo 'Mini Certification'; ?></option>
                                                                                                    <option value="2"><?php echo 'General'; ?></option>
                                                                                                </select>
                                                                                            </div>   
                                                                                                                <div class="form-group">
                                                                                                                    <label><?php echo $lang_tagname; ?></label>
                                                                                                                    ...
                                                                                                                    $.ajax(
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    if (obj.type == 'alert')
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        initJcrop2('/DedaaBox_dev/assets/uploads/articles_image/' + obj.msg.file_name);
                                                                                                                    ...
                                                                                                                    $.ajax(
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    if (obj.type == 'alert')
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        initJcrop3('/DedaaBox_dev/assets/uploads/articles_image/' + obj.msg.file_name);
                                                                                                                    ...
                                                                                                                    $.ajax(
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    if (obj.type == 'alert')
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        initJcrop1('/DedaaBox_dev/assets/uploads/articles_image/' + obj.msg.file_name);
