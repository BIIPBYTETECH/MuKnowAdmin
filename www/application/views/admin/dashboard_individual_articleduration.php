...
<!--                                <div id="chartContainer" style="height: 500px; width: 100%;">
                                ...
                                <div class="col-lg-12">
                                    <h2 class="page-header" style="color: #414042; border-bottom: 1px solid #adadad !important;">User Article Details <?php echo ucfirst($reg_row->username); ?>  Report</h2>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="panel panel-default">
...
//                                                              print_r($register_user);exit();
  ...
  <!--<td><?php // if($row->user_type=='1'){echo "Subscribed";}else{echo "Non Subscribed";} ?></td>-->
