...
<body>
    ...
    <div id="wrapper">
       ...
       <h2 class="page-header"><i class="fa fa-user fa-fw" id="sidemenuicon"></i> <?php echo 'Trainer'; ?> registered users (Approve and View <?php echo 'Trainer'; ?> Details) </h2>
                    ...
                    <?php } else {?>
                    <h2 class="page-header"><i class="fa fa-user fa-fw" id="sidemenuicon"></i> <?php echo str_replace('_',' ',ucfirst($this->uri->segment(4))); ?> registered users (View <?php echo str_replace('_',' ',ucfirst($this->uri->segment(4))); ?> Details) </h2>
                    <?php } ?>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                                ...
                                                <tr class="odd gradeX">
                                                   ...
                                                   <!--<td class="text-center">   </td>-->
                                                    ...
                                                    <td><?php  $transaction_date=date("Y-m-d H:i:s", strtotime($row->created_on." +8 hours"));
                                                       echo $transaction_date; }else{?></td> 
                                                    <td><?php if($row->updated_on!='0000-00-00 00:00:00' ){ $transaction_date=date("Y-m-d H:i:s", strtotime($row->updated_on." +8 hours"));
                                                    echo $transaction_date; }else{  $transaction_date=date("Y-m-d H:i:s", strtotime($row->created_on." +8 hours"));
                    ...
                    <script>$(document).on('click', '.model_form1', function () {
                                                    ...
                                                    $(document).ready(function () { 
                                                        ...
                                                        $('#dataTables-example').DataTable({
                                                            responsive: true,
                                                            'columnDefs': [{'orderable': false, 'targets': 4}], // hide sort icon on this column
                                                            'aaSorting': [[4, 'desc']] // start to sort data on this column
                                                        });
