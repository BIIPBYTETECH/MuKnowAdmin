...
<div id="form_modal_edit" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Form inside modal -->
            <?php echo form_open_multipart(site_url('/admin/dashbord_category/add_edit'), 'id="cat_formedit" class=".validate"  onsubmit="return myFunction_sub()"'); ?>
            <div class="modal-body with-padding">
                ...
                </div> <p id="err_name_sub" style="color:red; margin-top:-10px;"></p>
                <!--                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
...
<!--                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <span id="add">
                    ...
                    <div class="col-md-12">
                        <button type="button" class="btn btn-warning closebtn" data-dismiss="modal" style="color:#fff;">Close</button>
...
<div id="form_modal1edit" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Form inside modal -->
            <?php echo form_open_multipart(site_url() . 'admin/dashbord_category/edit_category', 'id="cat_form1edt"  onsubmit="return myFunction()" enctype="multipart/form-data"'); ?>
            <div class="modal-body with-padding">
                ...
                </div>  <p id="err_name" style="color:red; margin-top:-10px;"></p>
                <!--                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label>Name(In Chinese language):</label>
...
<!--                <div class="form-group">
        ...
        function myFunction() {
          var name,err_name;  
          name = document.getElementById("name1edt").value;
             if (name === '') {
        ...
        function myFunction_sub(){
             var name,err_name;  
          name = document.getElementById("subcatedit").value;
            
             if (name === '') {
                err_name = "Please Enter  Name.";
                document.getElementById("err_name_sub").innerHTML = err_name;
                return false;
            }else{
            return true;
        }
