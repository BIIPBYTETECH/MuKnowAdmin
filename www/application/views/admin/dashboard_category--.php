    ...
    <div id="wrapper">
        ...
        <?php if ($mode == 'all'): ?>
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header"><?php if ($this->uri->segment(3) == 'maincategory'): ?><i class="fa fa-th fa-fw" id="sidemenuicon"></i> Main Topics<?php
                            else: echo '<i class="fa fa-sitemap fa-fw" id="sidemenuicon"></i>' . " Sub Topics";
                            endif;
                            ?>  </h2>
                    </div>
                    <!-- /.col-lg-12 -->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <?php if ($this->uri->segment(3) == 'index'): ?>
                                    <a role="button"  class="align-left" title="Add sub Topics"><button type="button"style="float: right;margin-top: -4px;"  data1="builder_0" class="model_form btn smile-primary animated bounceIn">Add <i class="fa fa-plus" style="color:#fff;"></i></button></a>
                                ...
                                <?php else: ?>
                                    <a role="button"  class="align-left" title="Add Topics"><button type="button"style="float: right;margin-top: -4px;"  data1="builder_0" class="model_form1 btn smile-primary animated bounceIn">Add Topic <i class="fa fa-plus" style="color:#fff;"></i></button></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header smile-primary" style="border-radius:0px !important;">
                    ...
                    <h4 class="modal-title"><i class="icon-paragraph-justify2"></i> <span>Add</span> Sub Topic </h4>
                </div>
                <!-- Form inside modal -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header smile-primary" style="border-radius:0px !important;">
                    ...
                    <h4 class="modal-title"><i class="icon-paragraph-justify2"></i> <span>Add</span> Topic </h4>
                </div>
                <!-- Form inside modal -->
