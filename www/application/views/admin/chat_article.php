...
if ($mode == 'edit'):
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header" style="color: #414042; border-bottom: 1px solid #adadad !important;"><?php echo $lang_edit ?> <?php echo $lang_menu_article; ?> :</h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading" style="font-weight:bold;font-size:17px;">
                    ...
                    <a style="margin-top: -6px;float: right;" href="<?php echo site_url("admin/Dashboard_articles/index/" . $this->ion_auth->user()->row()->id) ?>/#<?php echo $this->uri->segment(5) ?>"> <button type="button" class="btn btn-info closebtn">Back</button></a>
                </div>
                <?php if ($this->session->flashdata('message')) { ?>
                    <div class="alert alert-success fade in block-inner">            
                        <button type="button" class="close" data-dismiss="alert">×</button>
...
//                                                }
                                        ...
                                        <?php if ($mode == 'view'): ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <h2 class="page-header" style="color: #414042; border-bottom: 1px solid #adadad !important;"><?php echo $lang_articlesdetails; ?>: </h2>
                                                </div>
                                                <!-- /.col-lg-12 -->
                                            </div>
                                            <div class="row" style="margin-left: 0px;margin-right: 0px;">
                                                <div class="panel-heading" style="background-color: #ed1c24 !important;font-weight: bold;color: #fff;font-size: 17px;margin:0px 15px 0px 15px;">
                                                    <?php echo $lang_articlesdetails; ?>
                                                    <a style="margin-top: -6px;float: right;" href="<?php echo site_url() ?>admin/Dashboard_articles/index/<?php echo $this->ion_auth->user()->row()->id; ?>"> <button type="button" class="btn btn-info" style="background-color: #414042;border-radius: 15px;border: none;"><?php echo $lang_back; ?></button></a>
                                                </div>
                                                <!-- /.panel-heading -->
                                                <div class="panel-body">
                                                                                ...
                                                                                <?php if (!empty($article_tag)): ?>
                                                                                    <?php foreach ($article_tag as $article_tag_row) { ?>
                                                                                        <div class="col-md-3" style="border-right:1px solid #CCC;">
                                                                                            <?php echo ucfirst($article_tag_row->tag_name); ?>
                                                                                        </div>
    ...
    $%x'
            ...
            <!--                                                                    <tr>
                                        ...
                                        <?php if ($mode == 'all'): ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <h2 class="page-header"> Online Chat Details </h2>
                                                </div>
                                                <!-- /.col-lg-12 -->
                                            </div>
                                            <?php if ($this->session->flashdata('message')) { ?>
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <div class="dataTable_wrapper">
                                                                            <table width="100%" class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                                                                                ...
                                                                                <tbody>
                                                                                    <?php
                                                                                    //echo 'hjj';print_r($notapprove_articles); exit;
                ...
                <?php endif; ?>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <a  href="<?php echo site_url(); ?>admin/Online_chat/chat/<?php echo $row->id; ?>" title="Chat" class="tip"><i  class="fa fa-wechat" title="Chat"></i></a>
                                                                                                    ...
                                                                                                    $.ajax(
                                                                                                            {
                                                                                                                ...
                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                {
                                                                                                                    ...
                                                                                                                    if (obj.type == 'alert')
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        initJcrop2('/oosmiles_dev/oosmiles/assets/uploads/articles_image/' + obj.msg.file_name);
                                                                                                    ...
                                                                                                    $.ajax(
                                                                                                            {
                                                                                                                ...
                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                {
                                                                                                                    ...
                                                                                                                    if (obj.type == 'alert')
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        initJcrop3('/oosmiles_dev/oosmiles/assets/uploads/articles_image/' + obj.msg.file_name);
                                                                                                    ...
                                                                                                    $.ajax(
                                                                                                            {
                                                                                                                ...
                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                {
                                                                                                                    ...
                                                                                                                    if (obj.type == 'alert')
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        initJcrop1('/oosmiles_dev/oosmiles/assets/uploads/articles_image/' + obj.msg.file_name);
