                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><button type="button" onclick="location.href='<?php echo base_url();?>admin/Dashboard_payment/update_unpaid/<?php echo $payment['order_id']; ?>'"class="btn btn-outline btn-danger btn-xs">Unpay</button></td>
                                            <td class="center"><button type="button" onclick="location.href='<?php echo base_url();?>admin/Dashboard_payment/paid_details/<?php echo $payment['order_id']; ?>'" class="btn btn-primary btn-xs">Order Details</button></td>
                                        </tr>
                                        <?php
                                        }}
                                        ?>
