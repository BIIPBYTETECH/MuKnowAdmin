                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="row">
                            <div class="col-md-12 responsive-1024">
                                ...
                                <img src="<?php echo base_url("{$upload_path_cat_img}/{$upload_data['file_name']}"); ?>"  height="500px" width="700px" id="corpcrop" alt="[Jcrop Example]" />                                                   
                            </div>
                            <div class="col-md-3 col-sm-12 responsive-1024 margin-top-20">
                                <?php echo form_open_multipart(site_url() . "admin/dashbord_slider/cropped_categoryimage", array('id' => 'corpcrop_form')) . "\r\n"; ?>
...
<!--                                    <input type="hidden" id="category_name" name="category_name" value="<?php echo $category_name ?>"/>-->
                                    <input type="hidden" id="ch_lang_name" name="name" value="<?php echo $name ?>"/>
                                    <input type="hidden" id="category_name" name="url" value="<?php echo $url ?>"/>
<!--                                    <input type="hidden" id="category_name" name="home_front" value="<?php echo $home_front ?>"/>-->
                                <?php } ?>
