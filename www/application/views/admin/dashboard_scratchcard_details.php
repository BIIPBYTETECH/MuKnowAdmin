        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="page-header"><i class="fa fa-credit-card" id="sidemenuicon"></i> <?php echo $batch . ' Scratch Card'; ?></h2>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default table-responsive">
                        ...
                        <div class="panel-heading table-responsive">
                            ...
                            <div style="float:right;"><a style="margin-top: -7px;float: right;" href="<?php echo site_url() ?>admin/Dashboard_scratchcard"> <button type="button" class="btn btn-info closebtn">Back</button></a></div>
