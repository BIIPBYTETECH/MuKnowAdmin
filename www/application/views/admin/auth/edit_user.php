...
<!--            <img alt="" src="<?php base_url(); ?>/assets/loader.gif" />-->
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-plus-circle" id="sidemenuicon"></i> Edit <?php
                    echo "Trainer"
                    ?></h2>
            </div>
            <!-- /.col-lg-12 -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <?php echo form_open("/admin/auth/edit_trainer/" . $id, 'class="validate"'); ?>
                                <div class="row">
    ...
    <!--                                            <p class="help-block">Example block-level help text here.</p>-->
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php //echo "Trainer"; //echo $trainer->user_type;  ?>
...
<!--                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php //echo $trainer->email ? $trainer->email : "N/A"; ?>
                                        </div>
...
<div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12  ">
                                                    <span class="append_img1"><img  style="display: inline-block;width: 150px;height: 150px;" class="thumbnail " src="<?php echo base_url(); ?>assets/uploads/profile_image/<?php echo $trainer->raw_name; ?><?php echo $trainer->file_ext; ?>">  </span>
                                                <hr>
                                            </div>
                                        </div>
...
<input type="submit" name="submit" value="Submit" class="btn smile-primary btn">
