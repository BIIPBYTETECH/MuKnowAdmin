            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 50px;">
                        <form role="form" id="add_form" method="post" action="<?php echo site_url() ?>admin/Dashboard_sequence/add_edit_data">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if (!empty($group)): ?>
                            <?php foreach ($group as $value) { ?>
                                <input type="hidden" name="group[]" value="<?php echo $value; ?>"/>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea id="nestable_list_1_output" name="article" class="form-control col-md-12 margin-bottom-10" style="display:none;"></textarea>
                                            ...
                                            <ol class="dd-list">
                                                <?php if (!empty($article)): $i = 1; ?>
                                                    ...
                                                    <?php foreach ($article as $article_row) { ?>
                                                        <li class="dd-item" data-id="<?php echo $article_row->id ?>">
                                                            <div class="dd-handle">
                                                                <div class="pull-left">
...
<?php else: ?>
                        ...
                        <a href="<?php echo site_url()?>admin/Dashboard_sequence/add_edit" style="float:right" type="reset" class="btn btn btn-warning">Cancel</a>
