...
<!--			<li>
            ...
            <?php endif; ?>
            <?php if ($this->ion_auth->is_admin() || !$this->ion_auth->is_trainer()): ?>
                <li>
                    <a href="#" id="user1"><i class="fa fa-users" id="sidemenuicon"></i> <?php echo ' Users';?> <?php echo ''; ?><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
             ...
             <?php if (!$this->ion_auth->is_trainer()): ?>   <li>
                            <a href="<?php echo site_url() ?>admin/Dashboard_user_trainers/index/trainer/" id="trainer"><i class="fa fa-user fa-fw" id="sidemenuicon"></i><?php echo 'Trainer'; ?></a>
<!--                    <ul class="nav nav-second-level">
...
<!--                <li>
				...
				<!--  <li>
				 ...
				 <li>
                    ...
                    <ul class="nav nav-second-level">
                         <li>
					<a id="art_menu" href="<?php echo site_url() ?>admin/Dashboard_payment/index"><i class="fa fa-credit-card" id="sidemenuicon"></i> <?php echo 'Customer Payment Details'; ?></a>                </li>
                  <li>
					<a id="art_menu" href="<?php echo site_url() ?>admin/Dashboard_payment/telenor"><i class="fa fa-credit-card" id="sidemenuicon"></i> <?php echo 'CashBack Payment Details'; ?></a>                </li>
                       
                    
                    
                       <li>
                           <a id="art_menu" href="<?php echo site_url() ?>admin/Dashboard_payment/cash_bach_revenue"><i class="fa fa-credit-card" id="sidemenuicon"></i> <?php echo 'CashBack  Revenue'; ?></a>    
                       </li>
                      </ul>
                    </li>
