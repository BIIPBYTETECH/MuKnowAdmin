...
<body>
   ...
   <div class="panel panel-default">
      ...
      <button type="button" class="add_assessment white btn btn-primary">Next</button>
      ...
      <div class="form-group">
      <label><?php echo $lang_imageto_upload; ?>:* <?php echo $lang_accepted_fromat; ?>: jpeg, jpg, png.(400X200)</label>
      ...
      <button type="button" class="add_assessment btn btn-primary">Next</button>
      <button style="float:right" type="reset" class="btn btn btn-warning closebtn">Reset</button>
      </div>   
      </form> 
      <!-- /.panel-body -->
                     ...
                     <form role="form" id="add_form" method="post" action="<?php echo site_url() ?>admin/Dashboard_assesment/add_edit_data">
                        <div class="row">
                           <div class="form-group">
                              <div class="col-md-4">
                                 <h4>
                                 <span>Mini Certification title:</span>
                                 <h4>
                              </div>
                              <div class="col-md-8">
                                 <h5><?php echo ucfirst($assesment_view->title); ?></h5>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="form-group">
                              ...
                              <div class="col-md-8">
                                 <h5><?php echo ucfirst($assesment_view->overview); ?></h5>
                              </div>
                           </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                           <div class="form-group">
                              ...
                              <div class="col-md-8">
                                 <h5><?php echo ucfirst($assesment_image->caption); ?></h5>
                              </div>
                           </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <h4><span>Articles question: </span></h4>
                           </div>
                        </div>
                        <?php
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="panel panel-default">
                  <div class="panel-heading sectionhead">
                     Mini Certification Details
                     <?php //echo site_url('admin/Dashboard_assesment/add_edit')   ?>                    <?php if (!empty($assesment_list)): ?>
                     <a href = "<?php echo site_url('admin/Dashboard_assesment/reorder_assesment_page'); ?>"role = "button" class = "" title = "Add sub Topics"><button type = "button"style = "margin-top: -6px;" data1 = "builder_0" class = "btn smile-primary">Click here to Reorder  Mini certification
                     </button></a>
                     ...
                     <div class="dataTable_wrapper">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 <td><?php echo $i; ?></td>
                                 <td><?php echo ucfirst(substr($row->title, '0', '35'));  ?></td>
                                 <td>
   ...
   <script>
      ...
      initJcrop1('/dedaabox/assets/uploads/assesment_image/' + obj.msg.file_name);
