<?php require_once('includes/head.php');// print_r($payment);?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default table-responsive">
                        ...
                        <div class="panel-heading table-responsive topbarheader">
                            <div style="float:left;">Name: <?php echo $payment[0]->strip_customer_name;?><br>
                            Email : <?php echo $payment[0]->email_id;?></div>
                            <div style="float:right;">Total:
                            
                            <?php $sum=0;foreach ($payment as $feed1) {
                                $sum+=$feed1->cash_back_amount;
                            }echo "$".$sum;
?>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php $i=0;foreach ($payment as $feed) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $feed->ref_user_email; ?></td>
