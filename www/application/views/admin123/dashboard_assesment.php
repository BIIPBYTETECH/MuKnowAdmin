            ...
            <div class="col-lg-12">
               <div class="panel panel-default">
                  <div class="panel-heading sectionhead">
                     ...
                     <a href = "<?php echo site_url('admin/Dashboard_assesment/reorder_assesment_page'); ?>"role = "button" class = "" title = "Add sub Category"><button type = "button"style = "margin-top: -6px;" data1 = "builder_0" class = "btn smile-primary">Click here to Reorder  Mini certification
                     </button></a>
