                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 responsive-1024 margin-top-20">
                                <?php echo form_open_multipart(site_url() . "admin/dashbord_slider/cropped_categoryimage_edit", array('id' => 'corpcrop_form')) . "\r\n"; ?>
...
<!--                                    <input type="hidden" id="category_name" name="category_name" value="<?php echo $category_name ?>"/>-->
                                    ...
                                    <input type="hidden" id="bh_lang_name" name="url" value="<?php echo $url ?>"/>
<!--                                    <input type="hidden" id="home_front" name="home_front" value="<?php if (!empty($home_front))echo $home_front ?>"/>-->
                                    <input type="hidden" id="ids" name="id" value="<?php echo $id ?>"/>
                                <input type="hidden" id="imgids" name="imgid" value="<?php echo $imgid ?>"/>
                                <?php } ?>
