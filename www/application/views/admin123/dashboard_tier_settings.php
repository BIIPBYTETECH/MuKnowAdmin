        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="page-header"><i class="fa fa-money" id="sidemenuicon"></i> <?php echo project_name . ' ' . 'Tier-Settings'; ?></h2>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default table-responsive">
                        ...
                        <div class="panel-heading table-responsive">
                            ...
                            <div style="float:right;"><a role="button"  class="align-left" title="Add Settings"><button type="button"  data1="builder_0" class="model_form1 btn smile-primary animated bounceIn">Add <?php echo 'Settings'; ?> <i class="fa fa-plus" style="color:#FFF;"></i></button></a></div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php $i=0;
                                    foreach ($subscription as $key=>$subscript) {
                                      $i++;  ?>
                                        <tr> 
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $subscript->tier_type; ?></td>
                                            <td><?php echo $subscript->cash_back; ?></td>                                           
    ...
    <div id="form_modal1" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Form inside modal -->
                <?php echo form_open_multipart(site_url() . '/admin/Dashboard_tier_settings/add_tier_settings', 'id="cat_form1"  enctype="multipart/form-data"  onsubmit="return myFunction()"'); ?>
                <div class="modal-body with-padding">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12">
                                <label>* Cash Back Price :</label><span style="color:#194c83"><i>(Only SG)</i></span>
...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="">
                                <div class="col-md-12"><label>* Tier Type :</label></div>
                                <div class="col-md-6">
                                    <select name="duration" id="duration" class="form-control required" >
                                        <option value="">--- Please Select ---</option>
                                       
                                        <option value="1">Tier-Type1</option>
                                        <option value="2">Tier-Type2</option>
                                    </select>
                                </div>
<!--
                                <div class="col-md-6">
...
//    alert( $('#del_mod').val());
var id=$('#del_mod').val();
 url = "<?php echo site_url() ?>/admin/Dashboard_tier_settings/delete_tier_setting";
...
//            }
            ...
            if (price === '') {
                err_price = "Please Enter Price for Settings.";
...
//            }
            ...
            if ( duration === '') {
                err_validity = "Please Select Type for Setting.";
