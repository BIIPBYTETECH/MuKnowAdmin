        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="page-header"><i class="fa fa-codepen" id="sidemenuicon"></i> <?php echo $lang_payment; ?></h2>
...
<!--                                    <th>Referral Code</th> 
                                    ...
                                    <?php $i=0; foreach ($payment as $feed) {
                                        $i++;?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $feed->strip_customer_name; ?></td>
                                            <td ><?php echo $feed->strip_customer_email; ?></td>
<!--                                            <td><?php echo $feed->referral_code; ?></td>
                                            <td><?php echo $feed->transaction_id; ?></td>
                                            <td><?php echo $feed->transaction_status; ?></td>
                                             <td><?php echo $feed->transaction_date; ?></td>-->
                                            <td class="text-center">    
                                                <a  href="<?php echo site_url() ?>admin/dashboard_payment/view_scratchcard/<?php echo $feed->user_id; ?>" title="View" class="tip"><i imagedata="image_dataclass<?php echo $feed->id; ?>" data="<?php echo 'builder_' . $feed->id; ?>" class="model_form_view fa fa-eye tip" title="View"></i></a>
                                            </td>    
                                        </tr>
                                        <?php
                                    }
