...
//        $this->load->view('admin/dashboard_articles_new_edit');
   redirect(site_url() . 'admin/Dashboard_quiz/edit_quiz/'.$id.'/'.$tab);
//redirect(site_url() . 'admin//dashboard_articles_new_edit/' . $user_id . "/#" . $tab);
      // redirect(site_url() . 'admin/Dashboard_quiz/edit_quiz/' . $article_id );
    }
