...
<?php //print_r($categories); exit(); ?>
                    ...
                    <!--                                                        <a  href="#"><i  data1="<?php echo 'builder_' . $row->id ?>" class="model_form fa fa-pencil"></i></a>-->
                                                            ...
                                                            <?php if ($this->uri->segment(3) == 'index'): ?>
                                                                ...
                                                                <a  href="#"><i   title="delete" data="<?php echo $row->id ?>" class="status_check fa fa-remove"><input type="hidden" id="status_check12_val" value="<?php echo $row->id;?>"></input></i></a>
                                                    ...
                                                    <a  href="#"><i   data="<?php echo $row->id ?>" class="status_check1 fa fa-remove"></i><input type="hidden" id="status_check1_val" value="<?php echo $row->id;?>"></input></a></td>
                                                <?php endif; ?>
                                                <?php
                                                $i++;
                                            }
         ...
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 <center>
                     ...
                     <button type="submit" name="" class="btn btn-danger" data-dismiss="modal" id="deleteformSubmit" >Yes, Delete</button>
                 </center>
             </div>
         </div>
     </form>
...
<div id="DeleteModal1" class="modal fade text-danger" role="dialog">
   <div class="modal-dialog ">
     <!-- Modal content-->
     <form action="" id="deleteForm1" method="post">
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 <center>
                     <input type="hidden" id="del_mod1"> <button type="button" class="btn btn-success" data-dismiss="modal">Cancel</button>
                     <button type="submit" name="" class="btn btn-danger" data-dismiss="modal" id="deleteformSubmit1" >Yes, Delete</button>
                 </center>
             </div>
         </div>
     </form>
...
console.log(response);
                    ...
                    $(document).on('click', '#deleteformSubmit', function () { 
                     ...
                     var status_val = $('#status_check1_val').val();
                                             $.ajax({
                                                type: "POST",
                                                url: url,
                                                data: {ct_id: status_val},
                                                success: function (data)
                                                {
         ...
         $(document).on('click', '#deleteformSubmit1', function () 
         {   
             url = "<?php echo site_url() ?>admin/Dashbord_category/delete_subcategory";
               var status_val = $('#status_check12_val').val();
                 $.ajax({
                         type: "POST",
                         url: url,
                         data: {ct_id: status_val},
