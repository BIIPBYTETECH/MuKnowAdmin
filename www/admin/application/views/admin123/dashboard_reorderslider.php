...
<body>
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-sort" id="sidemenuicon"></i> Re-order the <?php echo $category_name;?> Sliders</h2>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading sectionhead">
                        <form role="form" id="add_form" method="post" action="<?php echo site_url() ?>admin/Dashbord_slider/save_reoderslider">
                            <div>List of Sliders.</div>
                    ...
                    <div class="panel-body">
                                                ...
                                                <?php if (!empty($categories)):?>
                                                    ...
                                                    <li class="dd-item" data-id="1">
                                                        <div class="dd-handle">
                                                            ...
                                                            <div class="pull-left">
                                                                <strong>Slider not found.</strong>
                                                            </div>
                                                        </div>
                                                    </li> 
                                                <?php endif;
                        ...
                        <a href="<?php echo site_url()?>admin/Dashbord_slider/slider" style="float:right;color:#fff;" type="reset" class="btn btn closebtn">Cancel</a>
