...
<!--                          <input type="hidden" name="crop1" value="<?php echo htmlentities($crop1); ?>"/>-->
                        ...
                        <input type="hidden" name="author" value="<?php echo $author; ?>"/>
                         <input type="hidden" name="caption_image1" value="<?php echo $caption_image1; ?>"/>
                          ...
                          <input type="hidden" id="notification" name="notification" value="<?php echo $notification; ?>">
...
<?php else: ?>
                        ...
                        <a href="<?php echo site_url()?>admin/Dashboard_assesment/index/" style="float:right" type="reset" class="btn btn btn-warning">Cancel</a>
