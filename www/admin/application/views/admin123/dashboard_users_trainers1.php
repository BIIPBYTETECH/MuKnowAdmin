...
<!--                                <a href="<?php //echo site_url()?>/admin/auth/create_contributor" role="button"   title=""><button type="button" style="float:right;margin-top:-5px !important;" class="btn smile-primary">Create contributor <i class="fa fa-plus" style="color:#fff;"></i></button></a>-->
                            ...
                            <?php} elseif ($this->uri->segment(4) == 'facilitator'){?>
                                 <?php echo 'Trainer Details'; ?>
                                <a href="<?php echo site_url()?>/auth/create_user" role="button"   title=""><button type="button" style="" class="btn smile-primary">Create Trainer <i class="fa fa-plus" style="color:#fff;"></i></button></a>
                            <?php //endif; ?>
                            <?php }elseif ($this->uri->segment(4) == 'unsubscriber'){?>
                                 <?php echo ucfirst($this->uri->segment(4))?> Details
...
<!--                                                <button type="button" class="btn btn-xs btn-outline btn-primary model_form1" value="<?php echo $row->id ?>">Coupon view</button>--> 
                                                ...
                                                <a  href="<?php echo site_url(); ?>/Dashboard_users/<?php echo $this->uri->segment(4); ?>/view_coupon/<?php echo $row->id; ?>" title="View" class="tip"><button type="button" class="btn btn-xs btn-outline btn-primary model_form1" value="<?php echo $row->id ?>">Coupon view</button></a>
                                                    <?php } else { ?> 
                                                <button type="button" class="btn btn-xs btn-outline btn-primary " value="">No Coupon code applied</button>
                                                    ...
                                                    <td class="text-center">
                                                        <script>var builder_<?php echo $row->id; ?> = <?php echo json_encode($row); ?></script>
                                                         <?php //if ($this->uri->segment(4) == 'facilitator'){ ?>
                                                        <a  href="<?php echo site_url('/auth/edit_trainer/'.$row->id); ?>"><i  imagedata="image_dataclass<?php echo $row->id; ?>" data1="<?php echo 'builder_' . $row->id; ?>"class="model_form fa fa-pencil" title="Edit"></i></a>
                                                         <?php //} ?>
    ...
    <div id="form_modal_view" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="panel panel-default modal-content">
                ...
                <!-- Form inside modal -->
                <?php echo form_open_multipart(site_url() . '/dashbord_category/add_edit', 'id="cat_form" class=".validate"'); ?>
                                                    ...
                                                    $(document).ready(function () { 
                                                        ...
                                                        $(document).on('change', '.status_change_user_type', function () {
                                                            if (confirm("Are you sure want to change user type ?")) {
                                                                ...
                                                                url = "<?php echo site_url() ?>/Dashboard_createuser/user_type";
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: url,
                                                        ...
                                                        $(document).on('click', '.status_check', function () {
                                                            if (confirm("Do you want to delete ?")) {
                                                                ...
                                                                url = "<?php echo site_url() ?>/dashboard_postdetails/delete";
                                                        ...
                                                        $(document).on('click', '.approve_status', function () {
                                                            if (confirm("Are you sure want to approve ?")) {
                                                                ...
                                                                if ($(this).hasClass("btn-primary"))
                                                                    ...
                                                                    var status = 0;
                                                                url = "<?php echo site_url() ?>/Dashboard_users/approve_status";
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: url,
