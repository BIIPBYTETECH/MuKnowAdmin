        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="page-header"><i class="fa fa-codepen" id="sidemenuicon"></i> CashBack <?php echo $lang_payment; ?></h2>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <th>Transaction Time</th> 
                                        ...
                                        <!--<th>Billing id</th>-->
                                        <!--<th>Telenor Transcation Time</th>--> 
                                    </thead>
                                    ...
                                    <?php $i=0;foreach ($payment as $feed) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $feed->mobile_num; ?></td>
                                            <td><?php echo $feed->strip_customer_email; ?></td> 
                                            <td><?php  echo '$'.$feed->cash_back_amount; ?></td>
                                              <td><?php echo $feed->ref_user_name; ?></td>
                                            <!--<td><?php echo $feed->transaction_date; ?></td>-->
                                              <td><?php  $transaction_date=date("Y-m-d H:i:s", strtotime($feed->transaction_date." +8 hours"));
                                                       echo $transaction_date; ?></td> <!--<td ><?php //echo $feed->transaction_date; ?></td>-->
<!--                                            <td><?php echo $feed->ref_user_name; ?></td>-->
