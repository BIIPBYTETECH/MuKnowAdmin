        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12"> 
                    ...
                    <h2 class="page-header"><i class="fa fa-user fa-fw" id="sidemenuicon"></i>Courses Scores</h2>
                ...
                <div class="col-lg-12">
                    ...
                    <?php foreach($certify_user as $user) { 
                       //echo '<pre>'; print_r($user); exit;
                        $scores = $this->Courses_model->get_score_user($user->id);
						//,$user->courses_id,$user->chapter_id
                    ...
                    <div class="panel panel-default">
                        ...
                        <tr>
						  ...
						  <tbody> 
							  <?php if($scores){ foreach($scores as $score) { ?>
							  <tr>
							  ...
							  <?php } 
								...
								echo "<tr><td >No scores found.</td ></tr>";
							   }
							  ?>
							</tbody></table>
