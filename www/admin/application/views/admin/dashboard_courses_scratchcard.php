        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="page-header"><i class="fa fa-credit-card" id="sidemenuicon"></i> <?php echo ' Courses ' . $lang_menu_scratch_card; ?></h2>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php foreach ($scratchcard as $scratch) {
                                        ...
                                        <tr>
											...
											<td><a  href="<?php echo site_url() ?>admin/dashboard_courses_scratchcard/view_scratchcard/<?php echo $scratch->batch; ?>" method = "post" title="View" class="tip"><i imagedata="image_dataclass<?php echo $scratch->batch; ?>" data="<?php echo $scratch->batch; ?>" class="model_form2 fa fa-eye tip" title="View"></i></a></td>
                                        </tr>
                                        <?php
									}
									}
    ...
    <div id="form_modal1" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Form inside modal -->
                <?php echo form_open_multipart(site_url() . 'admin/dashboard_courses_scratchcard/add_scratchcard', 'id="cat_form1"  enctype="multipart/form-data"  onsubmit="return myFunction()"'); ?>
                <div class="modal-body with-padding">
					...
					<div class="form-group">
                        <div class="row">
                                ...
                                <div class="col-md-12"><label>* Courses :</label></div>
                                <div class="col-md-12">
                                    <select name="courses" id="courses" class="form-control required">
										<option value="">--- Please Select ---</option>
										<?php 
										foreach ($courses as $course) { //echo "<pre>"; print_r($course->id);  exit; ?>
										 <option value="<?php echo $course->id; ?>"> <?php echo ucwords($course->title); ?></option>
										 <?php } ?>
				...
				<p id="err_courses" style="color:red; margin-top:-10px;"></p>
					...
					<div class="form-group">
                        <div class="row">
                            <div class="">
                                <div class="col-md-12"><label>* Validity :</label><span style="color:#194c83"><i> ( Note:- 1 month = 28 days , 1 year = 365 days ) </i></span></div>
...
//<![CDATA[
    ...
    <script type="text/javascript">
        function myFunction() {
            var batch, courses,quantity, price, total, duration, comments, err_batch, err_quantity, err_price, err_validity, err_comments;
			...
			if (batch === '') {
				...
				document.getElementById("err_courses").innerHTML = '';
                return false;
            }
			...
			if (courses === '') {
                err_courses = "Please Enter courses.";
                document.getElementById("err_courses").innerHTML = err_courses;
