                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading" style="height:45px;">
                                Article details
                                <a style="margin-top: -5px;float: right;" href="<?php echo site_url() ?>/admin/Dashboard_articles/index/<?php echo $this->ion_auth->user()->row()->id; ?>"> <button type="button" class="btn btn-info">Back</button></a>
                            </div>
                            <?php //echo form_open_multipart(site_url() . '/admin/Dashboard_articles/add_edit_article', 'id="cat_form" class=".validate"');          ?>
                                                ...
                                                <?php if ($cat_del->deleted == '1'): ?>
                                                    <div class="alert alert-warning">
                                                        <p style="font-size:15px;">Category assigned to this article doesn't exist,kindly assign category before activate.<a href="<?php echo site_url("admin/Dashboard_articles/view_article/" . $article->id); ?>"  target="_blank" class="alert-link" style="text-decoration:none;font-size: 15px;"><i class="fa fa-eye" title="View" style="margin-right:2px;"></i> Click here to view the article details</a>&nbsp
                                                            <a href="<?php echo site_url("/admin/Dashboard_articles/add_edit_article/" . $article->id); ?>"  target="_blank" class="alert-link" style="text-decoration:none; font-size: 15px;"><i class="fa fa-pencil" title="Edit"></i> Click here to edit the article details</a>
                                                                                                               &nbsp
.</p>
                                                        
                                                        
                                                    </div>
                                                    <label>Selects Main Topic</label>
                                                    <?php
                                                    $main_category [''] = 'Choose category';
                                                    $options = 'data-placeholder="Choose a category..." class="form-control category_id select-full required" tabindex="2"';
                                                    echo form_dropdown('sp_id', $main_category, @$main_category->id, $options);
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-9 validate" >
                               ...
                               if($arttype == 'subscriber' || $arttype == 'non_subscriber') { ?>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-9 validate" >
                            <form role="form" id="quiz_add_edit_form" method="post" action="<?php echo site_url() ?>/admin/Dashboard_quiz/add_edit">
                                <div class=" form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" id="option1" name="option1" class="form-control " value="<?php ucfirst($quiz_row->option1); ?>">
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" id="option2" name="option2" class="form-control " value="<?php ucfirst($quiz_row->option2); ?>">
                                        </div>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" id="option3" name="option3" class="form-control " value="<?php ucfirst($quiz_row->question3); ?>">
                                        </div>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" id="option4" name="option4" class="form-control " value="<?php ucfirst($quiz_row->question4); ?>">
                                        </div>
                                    </div>
                                </div> 
                                <div class="form-group">
                                ...
                                <button type="button" id="b1" class="quiz_add_button btn btn-primary">Submit</button>
                                <?php  
                                // echo '<pre>'; print_r($arttype);exit;
                               if($arttype == 'subscriber' || $arttype == 'non_subscriber') { ?>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading sectionhead">
                    ...
                    <a style="margin-top: -5px;float: right;" href="<?php echo site_url("/admin/Dashboard_articles/index/" . $this->ion_auth->user()->row()->id) ?>/#<?php echo $this->uri->segment(5) ?>"> <button type="button" class="btn btn-info closebtn">Back</button></a>
                </div>
                <?php if ($this->session->flashdata('message')) { ?>
                    <div class="alert alert-success fade in block-inner">            
                        <button type="button" class="close" data-dismiss="alert">×</button>
    ...
    <!--                                    <form role="form"  id="artcle_edit_form" method="post" action="<?php //echo site_url("admin/Dashboard_articles/edit_article/" . $this->uri->segment(5))                                                        ?>" enctype="multipart/form-data">-->
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <select  name="language" data-placeholder="Choose a Subtopic..." class="form-control change_language select-full  required" tabindex="2">
...
//                                    echo form_dropdown('sp_id', $main_category, @$main_category->id, $options);
                            ...
                            ?>
                             <div class="form-group">
                                                                                             ...
                                                                                             <div class="form-group">
                                                                                                <label><?php echo 'Article Type'; ?>:</label>
                                                                                               <?php if($article->article_type =='mini_certification') { ?>   
                                                                                                  <input  class="form-control" value="<?php echo 'Mini Certification videos'; ?>" readonly="readonly" >
                                                                                                  <input  type="hidden" id="article_type_edit" value="<?php echo 'mini_certification'; ?>" name="article_type"  >
                                                                                               <?php } else {?>
                                                                                                <select style="height:40px !important;" id="article_type_edit" name="article_type" class="form-control article_type_edit required">
                                                                                                    <option value=""><?php echo 'Please select Article Type'; ?></option>
                                                                                                    <option value="subscriber" <?php if(!empty($article->article_type) && $article->article_type=='subscriber') echo 'selected';?>><?php echo 'Subscribed videos'; ?></option>
                                                                                                    <option value="non_subscriber" <?php if(!empty($article->article_type) && $article->article_type=='non_subscriber') echo 'selected';?>><?php echo 'Free videos'; ?></option>
                                                                                                    <option value="mini_certification" <?php if(!empty($article->article_type) && $article->article_type=='mini_certification') echo 'selected';?>><?php echo 'Mini Certification videos'; ?></option>
                                                                                                     <option value="courses" <?php if(!empty($article->article_type) && $article->article_type=='courses') echo 'selected';?>><?php echo 'Courses videos'; ?></option>
                                                                                                </select>
                                                                                               <?php } ?>
                                                                                            </div>
                                                ...
                                                <div class="form-group trailer">
                                                                                                    <label>* <?php echo 'Trailer Video URL'; ?></label>
                                                                                                        <input class="form-control" id="url" value="<?php if(!empty($article->trailer_video))echo $article->trailer_video; ?>" name="demo_file_name" >                                     
                                                                                                       <br>
                                                                                                     <input class="playvid" type="button" id="playvid" value="Click to Verify Trailer Video">
                                                                                                      <video id="myVideo" controls>
                                                                                                <source src="foo.ogg" type="video/ogg; codecs=dirac, speex">
                                                                                                Your browser does not support the <code>video</code> element.
                                                                                            </video><br/>
                                                                                                </div> 
                              <input type="hidden" name="type" id="img_type" value="3">
                                                                                                 
                                                                                                                    
                                                                                                                      <div class="form-group ">
                                                                                                    <label>* <?php echo 'Video URL'; ?></label>
                                                                                                        <input class="form-control required" id="urlmain" value="<?php if(!empty($article->url_link)) echo $article->url_link; ?>" name="file_name" >                                     
                                                                                                       <br>
                                                                                                     <input class="playvid" type="button" id="playvidmain" value="Click to Verify Video">
                                                                                                      <video id="myVideomain" controls>
                                                                                                <source src="foo.ogg" type="video/ogg; codecs=dirac, speex">
                                                                                                Your browser does not support the <code>video</code> element.
                                                                                            </video>
                                                                                                </div> 
                                            ...
                                            <?php if (!empty($article_tag)): ?>   
                                                <div class="form-group">
                                                    ...
                                                    <?php $k=1; $count_art = count($article_tag); foreach ($article_tag as $article_tag_row) { ?>
                                                        
														<label><?php echo 'Tag name '.$k; ?></label>
                                                        <input type="text"  class="form-control" name="edit_tags[]" maxlength="20" value="<?php echo ucfirst($article_tag_row->tag_name); ?>"/> 
														<br>
                                                   ...
                                                   $k++; }
                                                    ...
                                                    if (!empty($remaintag_count)):
                                                       for ($i = 1; $i <= $remaintag_count; $i++) {
                                                           $g =$count_art + $i; ?>
                                                                   <label><?php echo 'Tag name '.$g; ?></label>
...
//                                                }
                                            ...
                                            <button type="button" class="article_edit_button btn btn-primary"><?php echo $lang_submit; ?></button>
                                        ...
                                        <?php if ($mode == 'view'): ?>
                                            ...
                                            <div class="row" style="margin-left: 0px;margin-right: 0px;">
                                                <div class="panel-heading sectionhead" style="background-color: #194c83 !important;color: #fff;">
                                                    <?php echo $lang_articlesdetails; ?>
                                                    <a style="margin-top: -5px;float: right;" href="<?php echo site_url() ?>/admin/Dashboard_articles/index/<?php echo $this->ion_auth->user()->row()->id; ?>"> <button type="button" class="btn btn-info closebtn"><?php echo $lang_back; ?></button></a>
                                                </div>
                                                <!-- /.panel-heading -->
                                                <div class="panel-body" style="background-color:#fff;overflow-x:scroll;">
                                                            ...
                                                            if (isset($view_article) && count($view_article)):
                                                                ...
                                                                foreach ($view_article as $row) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2"><?php echo ucfirst($row->title); ?></td>
                                                                    </tr>
                                                                    <?php
                                                                    ...
                                                                    if ($cat_del->deleted == '0'):
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2"><?php echo ucfirst($cat); ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="5"><?php
                                                                                ...
                                                                                if ($language == 'zh')
                                                                                    echo ucfirst($row->category_ch_lang_name);
                                                                                if ($language == 'my')
                                                                                    echo ucfirst($row->category_bm_lang_name);
                                                                                ?></td>
                                                                        </tr>
                                                                    <?php else: ?>
                                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2"><?php echo ucfirst($row->username); ?></td>
                                                                    </tr>
													...
													print $tags ? substr($tags, 0, -2) : '';
														?>                                           
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2"><div style="width:800px; max-height:200px; overflow-Y:auto"><?php echo ucfirst($row->description); ?></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><?php echo $lang_shortdescription; ?></th>
                                                                        <td colspan="2"><?php echo ucfirst($row->short_description); ?></td>
                                                                    </tr>
            <!--                                                                    <tr>
                                                                    ...
                                                                    if (!empty($article_microlearning)):
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2"><div style="width:800px; max-height:200px; overflow-Y:auto"><?php echo ucfirst($article_microlearning->question); ?></div></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width:30%;font-weight: bold;"><?php echo $lang_option1; ?></td>
                                                                            <td colspan="2"><div style="width:800px; max-height:200px; overflow-Y:auto"><?php echo ucfirst($article_microlearning->option1); ?></div></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width:30%;font-weight: bold;"><?php echo $lang_option2; ?></td>
                                                                            <td colspan="2"><div style="width:800px; max-height:200px; overflow-Y:auto"><?php echo ucfirst($article_microlearning->option2); ?></div></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width:30%;font-weight: bold;"><?php echo $lang_option3; ?></td>
                                                                            <td colspan="2"><div style="width:800px; max-height:200px; overflow-Y:auto"><?php echo ucfirst($article_microlearning->option3); ?></div></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width:30%;font-weight: bold;"><?php echo $lang_option4; ?></td>
                                                                            <td colspan="2"><div style="width:800px; max-height:200px; overflow-Y:auto"><?php echo ucfirst($article_microlearning->option4); ?></div></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width:30%;font-weight: bold;"><?php echo $lang_answer; ?></td>
                                                                            <td colspan="2"><div style="width:800px; max-height:200px; overflow-Y:auto"><?php echo ucfirst($article_microlearning->answer_key); ?></div></td>
                                                                        </tr>
                                                                        <?php
                                                                    endif;
                                                                                ...
                                                                                <table width="100%" class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th><?php echo $lang_articletitle; ?></th>
                                                                                            <th><?php echo $lang_subcategiryname; ?></th>
                                                                                            <th><?php echo $lang_trainername; ?></th>
                                                                                            <th><?php echo $lang_article_name; ?></th>
                                                                                            <th><?php echo $lang_shortdescription; ?></th>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <?php //echo '<pre>'; print_r($notapprove_articles); exit;
                                                                                            ...
                                                                                            foreach ($notapprove_articles as $row) {
                                                                                             ...
                                                                                             ?>
                                                                                                <tr class="odd gradeX">
                                                                                                   ...
                                                                                                   <td><?php echo ucfirst(str_replace('_',' ',$row->article_type)); ?></td>
                                                                                                    <td><?php echo substr($row->short_description, '0', '35');  ?></td>
                                                                            ...
                                                                            <table width="100%" class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    foreach ($approved_articles as $row) {  
                                                                                        ...
                                                                                        if($row->article_type=='mini_certification')
                                                                                        { 
            ...
            <!--                                                                                                    <select class="form-control status_check_active" data="<?php echo $row->id; ?>">
                                                                                                    ...
                                                                                                    <a role="button" class="btn btn-primary status_check_active" data="<?php echo $row->id; ?>" data_status="0">Make De active</a>
                                                                                                    <?php } else {
                                                                                                   echo 'Since this article is added in mini certification you cant deactivate';     
                                                                                                    }
                                                                                                    ?></td>
                                                                                                <td><?php echo ucfirst($row->created_on) ?></td>
                                                                                                <td>
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                             ...
                                                                                             <div class="form-group">
                                                                                                ...
                                                                                                <select style="height:40px !important;" id="type" name="article_type" class="form-control article_type required">
                                                                                                    <option value=""><?php echo 'Please select Article Type'; ?></option>
                                                                                                    <option value="subscriber"><?php echo 'Subscribed videos'; ?></option>
                                                                                                    <option value="non_subscriber"><?php echo 'Free videos'; ?></option>
                                                                                                    <option value="mini_certification"><?php echo 'Mini Certification videos'; ?></option>
                                                                                                    <option value="courses"><?php echo 'Course videos'; ?></option>
                                                                                                </select>
                                                                                            </div>
                                                                                            <input type="hidden" class="type_file" name="type" value="3">
<!--                                                                                            <div class="form-group">
                                                                ...
                                                                <!--                                                    <input type="hidden" name="adv_id" id="id" value="">-->
                                                                                                               ...
                                                                                                               <div class="video_row ">
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <input type="file" class="fl styled form-control required" id="fl" name="file_name">
                                                                                                                        <span class="help-block"><?php echo $lang_accepted_fromat; ?>: mov,mpeg,avi,mp4.  </span>
                                                                                                                        <span class="help-block old_image4"></span>
                                                                                                                        <input type="hidden" name="adv_id" id="id" value="">
                                                                                                                ...
                                                                                                                <button type="button" id="b1" class="add_edit_button btn btn-primary"><?php echo $lang_submit; ?></button>
                                                                                                                                ...
                                                                                                                                <div class="row">
                                                                                                                                    <div class="col-sm-12  ">
                                                                                                                                        ...
                                                                                                                                        <p > <label >Profile Image:</label>
                                                                                                                                            <span class="append_img1"><img  style="display: inline-block;width: 150px;height: 150px;" class="thumbnail " src="<?php echo base_url(); ?>assets/uploads/profile_image/noimage.jpg">  </span>
                                                                                                                                        <hr>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                            ...
                                                                                                            $(document).ready(function () { 
                                                                                                               $('#myVideo').hide();
                                                                                                                    ...
                                                                                                                    $.ajax(
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    if (obj.type == 'alert')
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        initJcrop2('/dedaabox/assets/uploads/articles_image/' + obj.msg.file_name);
                                                                                                                    ...
                                                                                                                    $.ajax(
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    if (obj.type == 'alert')
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        initJcrop3('/dedaabox/assets/uploads/articles_image/' + obj.msg.file_name);
                                                                                                                    ...
                                                                                                                    $.ajax(
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                success: function (data, textStatus, jqXHR)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    if (obj.type == 'alert')
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        initJcrop1('/dedaabox/assets/uploads/articles_image/' + obj.msg.file_name);
                                                                                                                ...
                                                                                                                {  
                                                                                                                    ...
                                                                                                                    if(type == 'mini_certification' || type == 'courses')
                                                                                                                    { 
...
//                                                                                                                    if (type == '3')
//                                                                                                                    {    
//                                                                                                                        if(article_type== 'subscriber' || article_type == 'non_subscriber')
//                                                                                                                        {
//                                                                                                                           $('.trailer').show();
//                                                                                                                        } 
//                                                                                                                        else {
