                                                        ...
                                                        <div class="modal-content c-square" style="padding:15px">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="login-content upfrma"> 
                                                                    <?php //echo form_open_multipart('admin/dashboard_assesment/add_picture', array('class' => 'single', 'id' => 'upload-logo-form-control')) . "\r\n"; ?>
                                                                    <form action="javascript:;" class="single" id="upload-logo-form-control" rel="<?php echo site_url('admin/dashboard_assesment/add_picture');?>" >
                                                                    <div class="">
