<div class="modal fade c-content-login-form" id="upload-logo-form1" role="dialog">
                                                        ...
                                                        <div class="modal-content c-square" style="padding:15px">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="login-content upfrma"> 
                                                                    <?php echo form_open_multipart('admin/dashboard_articles/add_picture', array('class' => 'single', 'id' => 'upload-logo-form-control1')) . "\r\n"; ?>
                                                                    <div class="">
                                                                        <span id="mailme-alert1" style="color: #ec5e00"></span>
