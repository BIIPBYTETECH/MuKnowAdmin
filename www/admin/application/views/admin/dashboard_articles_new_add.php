        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="page-header"><i class="fa fa-codepen" id="sidemenuicon"></i> <?php echo $lang_quizdetails;;?></h2>
...
<!--                            <div style="float:right;"><a role="button"  class="align-left" title="Add Promocode"><button type="button"  data1="builder_0" class="model_form1 btn smile-primary animated bounceIn">Add <?php echo $lang_menu_promocode; ?> <i class="fa fa-plus" style="color:#FFF;"></i></button></a></div>-->
			...
			<br />
			<form method="post" id="quiz_add_edit_form" class="validate" method="post" action="<?php echo site_url() ?>admin/Dashboard_quiz/add_edit">
...
//                alert(article_id);
		...
		else
		{
			if($('#save').text() == 'Save')
			{
				...
				output += '<td>'+option1+' <input type="hidden" name="hidden_option1[]" id="option1'+count+'" value="'+option1+'" /></td>';
                                output += '<td>'+option2+' <input type="hidden" name="hidden_option2[]" id="option2'+count+'" value="'+option2+'" /></td>';
				output += '<td>'+option3+' <input type="hidden" name="hidden_option3[]" id="option3'+count+'" value="'+option3+'" /></td>';
                                output += '<td>'+option4+' <input type="hidden" name="hidden_option4[]" id="option4'+count+'" value="'+option4+'" /></td>';
                                output += '<td>'+answer_key+' <input type="hidden" name="hidden_answer_key[]" id="answer_key'+count+'" value="'+answer_key+'" /></td>';
			...
			else
			{
				...
				output += '<td>'+option3+' <input type="hidden" name="hidden_option3[]" id="option3'+row_id+'" value="'+option3+'" /></td>';
                                ...
                                output += '<td><input type="hidden" name="hidden_article_id[]" id="article_id'+row_id+'" value="'+article_id+'"/><button type="button" name="view_details" class="btn btn-warning btn-xs view_details" id="'+row_id+'">View</button></td>';
