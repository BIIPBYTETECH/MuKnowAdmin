...
class Dashboard_assesment_score extends Admin_Controller {
    ...
    public function __construct() {
     ...
     $data['certify_user'] = $this->Assessment_model->get_certificate_all_user();    
       //  echo '<pre>'; print_r($certify_user); exit; 
        ...
        $data['type'] = $this->uri->segment(3);
          ...
          $this->load->view('admin/dashboard_assesment_score', $data);
